...
window.SEARCH_DATA = [
  {
    t: "고양이도 열사병에 걸릴까? 여름나기 완벽 가이드",
    d: "고양이가 입을 벌리고 숨쉰다면 응급 신호 — 열사병 대처, 여름철 갇힘·추락 사고, 에어컨 온도와 수분 섭취.",
    c: "health", u: "posts/cat-summer-heat", e: "🌡️", m: "2026.07.24",
    k: "고양이 열사병 고양이 여름나기 개구호흡 입벌리고 숨쉼 헐떡임 팬팅 고양이 더위 에어컨 온도 쿨매트 탈수 수분섭취 방충망 추락 고층증후군 베란다 갇힘 단두종 페르시안 여름 식욕저하"
  },
  {
